...
export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'HuyHoang-doit MERN Stack Board',
    description: 'Pro MERN stack Course',
    type: 'public', // 'private'
    ownerIds: [], // Những users là Admin của board
    memberIds: [], // Những users là member bình thường của board
    columnOrderIds: ['column-id-03', 'column-id-01', 'column-id-02', 'column-id-04'],
    columns: [
      {
        _id: 'column-id-01',
        boardId: 'board-id-01',
        ...
        cards: [
          {
            ...
            cover: 'https://static.vecteezy.com/system/resources/thumbnails/034/895/404/small/ai-generated-smiling-man-illuminated-city-confident-enjoying-nightlife-looking-at-camera-generated-by-ai-photo.jpg',
      ...
      },
      {
        ...
        cards: [
          { _id: 'card-id-08', boardId: 'board-id-01', columnId: 'column-id-02', title: 'Title of card 08', description: null, cover: 'https://img.goodfon.com/wallpaper/big/c/7c/beautiful-fantasy-girl-digital-art-4k-wallpaper-kraski-dlinn.webp', memberIds: [], comments: [], attachments: [] },
      ...
      },
      {
        ...
        cards: [
          { _id: 'column-id-04-placeholder-card', boardId: 'board-id-01', columnId: 'column-id-04', FE_Placeholder: true }
        ]
      }
    ]
  }
